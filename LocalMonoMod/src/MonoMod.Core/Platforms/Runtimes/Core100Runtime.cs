...
namespace MonoMod.Core.Platforms.Runtimes
{
    ...
    internal class Core100Runtime : Core90Runtime
    {
        ...
        protected override int VtableIndexICorJitInfoAllocMem =>
            V100.ICorJitInfoVtable.AllocMemIndex;
        protected override int ICorJitInfoFullVtableCount =>
            V100.ICorJitInfoVtable.TotalVtableCount;

        // .NET 10 removed Type.GetTypeFromHandleUnsafe and reorganized the assembly object
        // layout; resolve JIT handles via public FromIntPtr APIs (see Core21Runtime) instead
        // of the GetTypeFromHandleUnsafe + MakeAssemblySystemAssembly path.
        protected override bool UseModernHandleResolution => true;
    }
}
